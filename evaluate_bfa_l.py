...
if __name__ == "__main__":
    ...
    opt.save_root = '/home/chenkerui/GenMo/checkpoints/bfa/LVAE_AE_RCE1_KGLE1_121_YL_ML160'
    ...
    mean_cls = np.load(pjoin(opt.data_root, "Mean.npy"))
    std_cls = np.load(pjoin(opt.data_root, "Std.npy"))
    ...
    for t in range(opt.repeat_times):
        ...
        for i, data in enumerate(data_loader):
            ...
            if opt.sampling and i%mm_sample_per==0:
                ...
                TMM = transform(TMM.float().to(opt.device)).permute(0, 2, 1)
...
# unsuper:python evaluate_bfa_l.py --name LVAE_AE_RCE0_KGLE2_12E1_ML160 --gpu_id 2 --dataset_name bfa --motion_length 160 --ext cmu_SP_IK --batch_size 12 --use_ik --niters 1
# label:python evaluate_bfa_l.py --name LVAE_AE_RCE1_KGLE1_121_YL_ML160 --gpu_id 1 --dataset_name bfa --motion_length 160 --ext cmu_SP_IK --use_style --batch_size 12 --use_ik --niters 1 --sampling
# motion:python evaluate_bfa_l.py --name LVAE_AE_RCE1_KGLE1_121_YL_ML160 --gpu_id 1 --dataset_name bfa --motion_length 160 --ext cmu_NSP_IK --use_style --batch_size 12 --use_ik --niters 1