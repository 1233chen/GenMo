...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--repeat_times', type=int, default=10, help="Number of generation rounds for each text description")
        ...
        self.parser.add_argument('--ext', type=str, default='cmu_NSP_IK', help='Save file path extension')

        self.parser.add_argument('--sampling', action="store_true", help='models are saved here')
        self.parser.add_argument('--use_ik', default = True, action="store_true", help='models are saved here')
