...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--name', type=str, default="MAE_SMSE3_SPAE3_DZ512_DOWN2", help='Name of this trial')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/data/chenkerui1/genmo/checkpoints', help='models are saved here')

        self.parser.add_argument("--motion_length", type=int, default=160, help="Length of motion")
