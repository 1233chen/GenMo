...
from networks.trainer import ClassifierTrainer
...
if __name__ == "__main__":
    ...
    trainer = ClassifierTrainer(opt, classifier)
    train_dataset = MotionDataset(opt, mean, std, train_data_path, fix_bias=True)
    val_dataset = MotionDataset(opt, mean, std, test_data_path, fix_bias=True)
